...
interface ILauncherClient {
    ...
    companion object {
        ...
        fun create(launcher: Launcher): ILauncherClient = FlickNowClient(launcher)
        ...
        fun getEnabledState(context: Context): Int {
            ...
            if (!PackageManagerHelper.isAppEnabled(context.packageManager, FlickNowClient.PROXY_PACKAGE, 0))
